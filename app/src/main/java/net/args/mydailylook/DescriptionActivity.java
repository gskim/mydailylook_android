...
/**
 * Created by arseon on 2016-06-18.
 */
public class DescriptionActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View githubView = findViewById(R.id.textview_main_github_link);
        ...
        Button loginBtn = (Button) findViewById(R.id.btn_activity_description_login);
        SCViewAnimation loginAnimation = new SCViewAnimation(loginBtn);
        loginAnimation.startToPosition(size.x, null);
        loginAnimation.addPageAnimation(new SCPositionAnimation(this, 3, -size.x, 0));
        mViewPager.addAnimation(loginAnimation);
        loginBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DescriptionActivity.this, LoginActivity.class);

                View sharedView = githubView;
                String transitionName = getString(R.string.title_transition);

                ActivityOptions transitionActivityOptions = ActivityOptions.makeSceneTransitionAnimation(DescriptionActivity.this, sharedView, transitionName);
                startActivity(intent, transitionActivityOptions.toBundle());
//                Intent intent = new Intent(DescriptionActivity.this, LocationSearchActivity.class);
//                startActivity(intent);
            }
        });

        Button joinBtn = (Button) findViewById(R.id.btn_activity_description_join);
        SCViewAnimation joinAnimation = new SCViewAnimation(joinBtn);
        joinAnimation.startToPosition(size.x, null);
        joinAnimation.addPageAnimation(new SCPositionAnimation(this, 3, -size.x, 0));
        mViewPager.addAnimation(joinAnimation);
        joinBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DescriptionActivity.this, JoinActivity.class);
